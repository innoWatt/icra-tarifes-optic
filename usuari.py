...
# -*- coding: utf-8 -*-
'''
	CREAR I ENVIAR TRAMES AL COMPTADOR a nivel usuari
...
#prova asdu 162: instantanis
P.pregunta(C.creaTramaVar(0b01110011,d,C.creaASDU162()))
...
P.pregunta(C.creaTramaVar(0b01110011,d,C.creaASDU123(11,1,1,C.creaTemps(21,5,16,1,0),C.creaTemps(23,5,16,0,0))))
